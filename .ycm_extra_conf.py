...
KERNEL_PATH = '/home/remol/Projects/linux-can-next/'
KERNEL_ARCH = 'x86'
...
flags_c = [
    ...
    '-I', KERNEL_PATH + 'include',
    '-I', KERNEL_PATH + 'arch/' + KERNEL_ARCH + '/include',
    '-I', KERNEL_PATH + 'arch/' + KERNEL_ARCH + '/include/uapi',
    '-I', KERNEL_PATH + 'arch/' + KERNEL_ARCH + '/include/generated',
    '-I', KERNEL_PATH + 'arch/' + KERNEL_ARCH + '/include/generated/uapi',
